...
struct ContentView: View {
    ...
    @State private var editingItem: FamilyrecipeboxItem?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Family Recipe Box")
            .toolbar {
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(item == nil ? "Add Recipe" : "Edit Recipe")
            .toolbar {
